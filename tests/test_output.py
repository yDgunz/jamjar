...
def test_generate_output_name_with_timestamps():
    ...
    assert name == "1_02m00s-06m00s.m4a"
...
def test_generate_output_name_zero_padded():
    ...
    assert name == "03_00m00s-01m30s.m4a"
...
def test_generate_output_name_with_song_name():
    ...
    assert name == "1_00m00s-05m00s_Fat-Cat.m4a"


def test_generate_output_name_no_timestamps():
    name = generate_output_name(track_number=1, total_tracks=1)
    assert name == "1.m4a"
...
def test_generate_output_name_explicit_extension():
    ...
    assert name == "1_00m00s-05m00s.m4a"
